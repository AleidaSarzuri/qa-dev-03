...
var number = 10;
var getNumberEven = function(number)
{
...
var getNumberOdd = function(number)
{
    var evenNumbers =[];
...
console.log('The first number odd:',getNumberOdd(number),'and the first number even:',getNumberEven(number));
var number = 5;
...
console.log('The factorial :',factorial(number));
